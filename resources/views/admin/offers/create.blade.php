            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description_ar" rows="3" dir="rtl"
                              class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-rose-gold resize-none">{{ old('description_ar') }}</textarea>
                </div>
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description_en" rows="3" dir="ltr"
                              class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-rose-gold resize-none">{{ old('description_en') }}</textarea>
                </div>
                <div>
