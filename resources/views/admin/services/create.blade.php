<x-layouts.admin :title="__('web.add_new')">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('admin.services.index') }}" class="text-gray-400 hover:text-rose-gold">← {{ __('web.back') }}</a>
        <h1 class="text-2xl font-bold text-gray-800">{{ __('web.admin_services') }} — {{ __('web.add_new') }}</h1>
    </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="duration_minutes" value="{{ old('duration_minutes', 60) }}" min="5" required
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <textarea name="description_ar" rows="4" placeholder="الوصف بالعربية" dir="rtl"
                                      class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-gold/20 focus:border-rose-gold resize-none transition">{{ old('description_ar') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="description_en" rows="4" placeholder="Description in English"
                                      class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-gold/20 focus:border-rose-gold resize-none transition">{{ old('description_en') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <label for="service-image-input"
                        ...
                        <span class="text-xs text-gray-400 group-hover:text-rose-gold/60 transition text-center">
                            {{ app()->getLocale() === 'ar' ? 'اضغط لرفع صورة' : 'Click to upload image' }}
                        </span>
